//  Created by Đỗ Trần Anh Tuấn on 01/04/2018.
//  Copyright ©2018 AnhTuan. All rights reserved.
...
struct Student // Khai báo cấu trúc sinh viên
{
	string Code;
	string Name;
	string Faculty;
...
Student SV[1000]; // Khai báo mảng SV gồm 1000 phần tử
int number = 0;
const int total = 9;// Đây chính là số biến mà ta đặt trong file html 
...
Ex: "Xin chao $name"
Sau khi thay đổi là: "Xin chao tuan dep trai"
*/
...
*/
void Write_Temple(string temp_line[1000], int i, int count)
{
	/*
...
{
	int pos;
	int n = 0;/*số lượng sinh viên được lưu trong dữ liệu*/
	Read(SV, n);
